        ...
        <div class="auth-card">
            <div class="auth-card-body">
                ...
                <div class="auth-header">
                    ...
                    <p class="auth-subtitle">Login to manage your content and billing.</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="auth-form-group">
                        ...
                        <div class="auth-input-wrapper">
                            <input type="password" id="auth-password" class="auth-input" name="password" placeholder="Enter your password" required>
                    ...
                    <div class="auth-checkbox-wrapper">
                        <input type="checkbox" id="remember" name="remember" value="1" class="auth-checkbox">
