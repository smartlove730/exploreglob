        ...
        <div class="col-lg-8">
            <div class="animated-card" style="opacity:1;transform:none">
                <div class="card-body p-5">
                    ...
                    <p class="card-text">Whether you're a solopreneur or a growing team, Postzy gives you the tools to manage your social presence across Facebook, Instagram, and Google Business — all in one place.</p>
                </div>
            </div>
        </div>
    </div>
