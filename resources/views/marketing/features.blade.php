...
<div class="container my-5">
    <div class="row g-4">
        ...
        <div class="col-md-6"><div class="animated-card" style="opacity:1;transform:none"><div class="card-body p-4"><h5 class="card-title">🌐 Cross-Platform Publishing</h5><p class="card-text">Publish to Facebook and Instagram based on plan capabilities.</p></div></div></div>
