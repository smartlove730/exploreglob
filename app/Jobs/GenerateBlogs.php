...
The content should sound insightful, helpful, and written by a human. Use realistic and educational examples, not overly generic text.";
    ...
    'seo_title'       => trim(preg_replace('/\[[^\]]*\]/', 'Explore-Glob', $aiRaw['seo_title'])) ?? (trim(preg_replace('/\[[^\]]*\]/', 'Explore-Glob', $aiRaw['title']))  ?? 'Untitled'),
...
$originalUrl=[];
 ...
 $response = Http::withHeaders([
    ...
    return [
        ...
        'seo_title' =>  trim(preg_replace('/\[[^\]]*\]/', 'Explore-Glob', $data['seo_title'] ?? $data['title'] ?? '')) ?? '',
